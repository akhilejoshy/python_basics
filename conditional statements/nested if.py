#Q simple calculatar using nested if ?
print('1,Addition \n2,subtraction \n3,multiplication \n4,division')
...
#Q accept age gender and number of working days from user and display the wages according to the following criteria using nested if
