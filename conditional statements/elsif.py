##--->elif statement
##--->the elif statement alow you to check multiple expresions for true and execute a block of code as soon as one to the condition evaluvater to true
##--->  if():
##--->      body
##--->  elif():
##--->      body
...
##----->  4,check a day input by user is weekday or weekend
...
##----->  find the min of 5 number
# a=int(input('enter 1st number:'))
# b=int(input('enter 2nd number:'))
# c=int(input('enter 3rd number:'))
# d=int(input('enter 4th number:'))
# e=int(input('enter 5th number:'))r
